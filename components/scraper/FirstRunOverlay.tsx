    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-slate-950/70 px-4 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-[28px] border border-white/10 bg-[#0b1220] p-6 shadow-[0_30px_90px_rgba(2,8,23,0.68)]">
        ...
        <button
          type="button"
          onClick={dismiss}
          className="mt-8 inline-flex min-h-[52px] w-full items-center justify-center rounded-2xl border border-cyan-300/30 bg-[linear-gradient(135deg,rgba(34,211,238,0.95),rgba(20,184,166,0.92))] px-5 text-base font-semibold text-slate-950 shadow-[0_18px_40px_rgba(14,165,233,0.24)] transition hover:-translate-y-0.5"
        >
          Got it
        </button>
      </div>
