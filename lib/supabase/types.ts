...
export type UserProfile = {
  ...
  first_search_date?: string | null;
  first_export_date?: string | null;
  first_upgrade_click_date?: string | null;
  paid_conversion_date?: string | null;
  created_at: string;
};
  ...
  public: {
    Tables: {
      ...
      user_attribution: {
        ...
        Update: Partial<Database["public"]["Tables"]["user_attribution"]["Insert"]>;
      };
      search_analytics: {
        Row: {
          id: string;
          ...
          referrer: string | null;
          first_landing_page: string | null;
          viewed_results: boolean;
          opened_lead_detail: boolean;
          downloaded_csv_after_search: boolean;
          email_exported_after_search: boolean;
          performed_another_search: boolean;
          viewed_pricing_after_search: boolean;
          clicked_upgrade_after_search: boolean;
