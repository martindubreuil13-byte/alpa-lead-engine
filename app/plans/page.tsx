            ...
            <div className="relative mx-auto flex max-w-2xl flex-col items-center">
              ...
              <div className="mt-8 flex w-full max-w-[32rem] flex-col gap-3 sm:flex-row sm:items-center sm:justify-center">
                <FreeTrialPlanLink
                  ...
                  className="inline-flex min-h-[54px] flex-1 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.06] px-7 text-sm font-semibold text-white transition-all duration-200 hover:border-white/16 hover:bg-white/[0.10]"
                >
                  Start Free
                </FreeTrialPlanLink>
                <StartCheckoutButton
